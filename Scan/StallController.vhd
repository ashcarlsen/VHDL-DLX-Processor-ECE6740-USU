...
begin
    ...
    stall_update : process(IF_ID_RS1, IF_ID_RS2, IF_ID_OP, ID_EX_OP, ID_EX_RD, SCAN_FIFO_EMPTY)
    begin
        ...
        if(((IF_ID_OP = GD) or (IF_ID_OP = GDU)) and (SCAN_FIFO_EMPTY = '1')) then
            SCAN_STALL <= '1';
        else
            SCAN_STALL <= '0';
        end if;
    ...
    STALL <= LOAD_STALL or PRINT_FIFO_FULL or SCAN_STALL;
